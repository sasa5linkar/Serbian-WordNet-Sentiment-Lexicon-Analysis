...
This script applies pre-trained sentiment analysis models, including ADA and NB (Naive Bayes), to estimate sentiment polarity in Serbian WordNet synsets.
...
sword2.to_csv(RES_DIR + "srbsentiwordnet2.csv", columns=["ID", "POS", "NEG", "Lemme", "Definicija"])  
sword2.to_csv(RES_DIR + "srbsentiwordnet_a2.csv", columns=["ID", "POS", "NEG", "Lemme", "Definicija", "Vrsta"])  
